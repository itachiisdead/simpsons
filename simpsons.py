...
# Create the main window
root = tk.Tk()
root.title("Simpsons classification App")
root.config()
width=600
height=500
...
image_frame = tk.Frame(root, width=390, height=300, bg="white")  # Set background color (optional)
image_frame.pack()
image_label = tk.Label(image_frame, image=bg_image)
...
# Create "Select Image" button
select_image_button = tk.Button(root, text="Select Image", command=select_image,bg="#FFC100",fg="#000",relief="ridge",height="2",width="13")
select_image_button.pack(pady=10)
...
# Create "Make Prediction" button
make_prediction_button = tk.Button(root, text="Make Prediction", command=lambda: make_prediction(selected_image_path),bg="#FFC100",fg="#000",relief="ridge",height="2",width="13")
make_prediction_button.pack(pady=10)
